...
def normalize_landmarks(landmarks):
    ...
    # Center landmarks around the centroid
    ...
    if max_distance > 0:
        ...
        landmarks_normalized = landmarks_centered  # Avoid division by zero
    ...
    for gesture in gestures:
        ...
        while True:
            ...
            if key == ord('s'):
                ...
                exit()
        count = 0
        # Set target count based on the gesture
...
def gesture_recognition(clf, le, scaler):
    ...
    last_action_times = {}
    action_delay = 1.0  # Delay in seconds
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            for idx, hand_landmarks in enumerate(results.multi_hand_landmarks):
                ...
                # Control applications with delay
                current_time = time.time()
                hand_id = idx  # Use the hand index as the key
